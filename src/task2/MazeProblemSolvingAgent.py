...
class MazeProblemSolvingAgent(SimpleProblemSolvingAgentProgram):
  def __init__(
    ...
    # Set goals as 1 random treasure, then maze end
    self.goal = [random.choice(treasure_states), end_state]
  ...
  def search(self, problem):
    ...
    print("Solution (a sequence of actions) from the selected state to a goal: {}".format(solution))
    return solution
